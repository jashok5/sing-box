...
require (
	...
	github.com/sagernet/cronet-go v0.0.0-20251231120443-1d2d7341cbd8 // indirect
	github.com/sagernet/cronet-go/all v0.0.0-20251231120443-1d2d7341cbd8 // indirect
